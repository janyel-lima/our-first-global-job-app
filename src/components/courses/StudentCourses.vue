...
<template>
  <div id="student-courses-panel" class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 bg-slate-50 dark:bg-slate-800/40 p-4 rounded-3xl border border-gray-150 dark:border-slate-700/80">
      <!-- Search query input -->
      ...
      <div class="flex flex-row items-center gap-3 shrink-0 w-full sm:w-auto justify-between sm:justify-start">
        <span class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider flex items-center gap-1.5 whitespace-nowrap">
    ...
    <div id="community-channels-widget" class="bg-white dark:bg-slate-850 p-5 sm:p-6 rounded-3xl border border-gray-150 dark:border-slate-700/80 shadow-2xs space-y-4 text-left">
      <div>
        <h3 class="text-xs sm:text-sm font-black text-slate-900 dark:text-white flex items-center gap-1.5 uppercase tracking-wide">
        ...
        <p class="text-[10px] text-gray-400 dark:text-gray-500 font-bold mt-0.5">
          {{ locale === 'pt' ? 'Mantenha-se atualizado com avisos de aulas, materiais extras e links importantes' : 'Keep up to date with class schedules, extra materials and important links' }}
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-[10px] text-emerald-700/80 dark:text-emerald-500 font-semibold mt-0.5 leading-tight line-clamp-2">
              {{ locale === 'pt' ? 'Fale com professores, marque aulas e tire suas dúvidas na hora.' : 'Talk with teachers, book classes, and ask questions instantly.' }}
            </p>
          </div>
          <span class="text-emerald-600 dark:text-emerald-400 font-black text-[9px] uppercase tracking-wider shrink-0 bg-emerald-100 dark:bg-emerald-950/85 px-2 py-1 rounded-lg">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-[10px] text-sky-700/80 dark:text-sky-500 font-semibold mt-0.5 leading-tight line-clamp-2">
              {{ locale === 'pt' ? 'Receba materiais de estudo diários, arquivos em PDF e agendas.' : 'Get daily study materials, PDF files, and schedules.' }}
            </p>
          </div>
          <span class="text-sky-600 dark:text-sky-400 font-black text-[9px] uppercase tracking-wider shrink-0 bg-sky-100 dark:bg-sky-950/85 px-2 py-1 rounded-lg">
            {{ locale === 'pt' ? 'Acessar' : 'Access' }}
          </span>
        </a>
      </div>
