  ...
  <div id="progress-tracking-panel" class="space-y-6 text-left animate-fadeIn">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="bg-white dark:bg-slate-900 border border-slate-200/75 dark:border-slate-800 p-5 rounded-2xl flex items-center gap-4 shadow-2xs">
        ...
        <div>
          <span class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider block leading-none mb-1">Cursos Concluídos</span>
      ...
      <div class="bg-white dark:bg-slate-900 border border-slate-200/75 dark:border-slate-800 p-5 rounded-2xl flex items-center gap-4 shadow-2xs">
        ...
        <div>
          <span class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider block leading-none mb-1">Lições Completadas</span>
          <p class="text-2xl font-black text-slate-800 dark:text-white leading-none">
      ...
      <div class="bg-white dark:bg-slate-900 border border-slate-200/75 dark:border-slate-800 p-5 rounded-2xl flex items-center gap-4 shadow-2xs">
        ...
        <div class="flex-1">
          <span class="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-wider block leading-none mb-1">Fluência Auto-Avaliada</span>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 rounded-3xl p-6 space-y-4">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800/80 pb-4 select-none">
        <div>
          <h3 class="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider block">Lista Global de Certificados Ganhos</h3>
          <p class="text-xs text-slate-400 dark:text-slate-350 font-bold block">Todos os cursos finalizados aparecem listados abaixo independente do seu nível de inglês configurado.</p>
        </div>
      </div>
