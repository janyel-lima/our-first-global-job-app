          ...
          <div v-if="userProfile" class="relative shrink-0">
            ...
            >
              ...
              <div class="flex items-center gap-1.5 pr-1 text-left">
                <span class="text-xs font-extrabold text-slate-800 dark:text-slate-200 truncate max-w-[65px] sm:max-w-[100px] leading-none">
            ...
            >
              ...
              <div class="bg-slate-50 dark:bg-slate-950/25 p-3.5 rounded-xl border border-slate-150 dark:border-slate-800/80 space-y-3">
                ...
                <div class="flex items-center justify-between pt-2.5 border-t border-slate-200/60 dark:border-slate-800/50">
                  ...
                  <div class="flex items-center gap-1 text-[9px] font-black uppercase tracking-wider text-slate-500 dark:text-slate-400">
                    <span class="w-1.5 h-1.5 rounded-full animate-pulse shrink-0" :class="isOnline ? 'bg-emerald-500' : 'bg-red-500'"></span>
              ...
              <button
                type="button"
                @click="emit('open-profile'); closeProfileDropdown();"
              ...
              <div class="space-y-1.5">
                ...
                <div class="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <div class="min-w-0">
                      <h5 class="font-black text-[9px] text-emerald-950 dark:text-emerald-400 group-hover:underline leading-none">WhatsApp</h5>
                      <span class="text-[8px] text-emerald-600/80 font-bold mt-0.5 block truncate">{{ locale === 'pt' ? 'Grupo' : 'Group' }}</span>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div class="min-w-0">
                      <h5 class="font-black text-[9px] text-sky-950 dark:text-sky-400 group-hover:underline leading-none">Telegram</h5>
                      <span class="text-[8px] text-sky-600/80 font-bold mt-0.5 block truncate">{{ locale === 'pt' ? 'Canal' : 'Channel' }}</span>
                    </div>
                  </a>
                </div>
              </div>
