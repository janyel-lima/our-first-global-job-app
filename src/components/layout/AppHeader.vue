    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 flex items-center justify-between">
      ...
      <div class="flex items-center gap-1.5 sm:gap-2.5 cursor-pointer shrink-0 animate-fadeIn"
        ...
        <div class="flex flex-col text-left">
          <span class="font-black text-[10px] xs:text-xs sm:text-sm tracking-tight text-slate-900 leading-tight">Our
            First Global Job</span>
          <span
            class="text-[8px] sm:text-[9px] font-bold text-slate-400 dark:text-slate-600 uppercase tracking-widest leading-none mt-0.5">Learning
            App</span>
        </div>
      ...
      <div class="flex items-center gap-2 sm:gap-6">
        ...
        <div
          class="flex items-center gap-2 sm:gap-3 border-l border-slate-250 dark:border-slate-300 pl-2 sm:pl-4 shrink-0">
          ...
          <div class="relative shrink-0">
            <button type="button" @click="showThemePanel = !showThemePanel" title="Personalizar Cores e Tema" :class="[
              ...
              <span class="hidden lg:inline text-[10px] font-extrabold"
                :class="showThemePanel ? 'text-white' : 'text-slate-700'">Tema</span>
            </button>
              ...
              <div class="space-y-1.5 pb-2 border-b border-slate-100/60">
                ...
                <div class="grid grid-cols-2 gap-2">
                  <button type="button" @click="emit('update:isDarkMode', false)" :class="[
                    ...
                    <Sun class="w-3.5 h-3.5" :style="!isDarkMode ? { color: '#ffffff' } : { color: '#f59e0b' }" /> Claro
                    (Light)
                  </button>
          ...
          <!-- Logout Button -->
          <button id="btn-nav-logout" @click="emit('logout')" title="Sair da plataforma"
