  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start text-left">
      ...
      <div
        ...
        <div
          class="p-3.5 bg-blue-50/50 dark:bg-slate-900/60 border border-dashed border-blue-200 dark:border-slate-750 rounded-xl text-center space-y-2">
          <div class="text-center">
            <UploadCloud class="w-6 h-6 text-blue-500 dark:text-blue-400 mx-auto" />
            <p class="text-[10.5px] font-bold text-blue-900 dark:text-slate-100 mt-1">Carregar Múltiplos Arquivos .MD
            </p>
            <p class="text-[9.5px] text-blue-600 dark:text-slate-350">Importe textos prontos com tabelas e diálogos para
              acelerar.</p>
          </div>
        ...
        <div v-else class="space-y-2">
          <div v-for="(less, idx) in lessonsList" :key="less.tempId" :class="[
            ...
            <div class="flex items-center gap-2 truncate pr-1">
              <span
                class="w-5 h-5 rounded bg-slate-100 dark:bg-slate-800 text-[10px] text-slate-500 dark:text-slate-405 font-bold flex items-center justify-center shrink-0">
                {{ idx + 1 }}
              </span>
              <p :class="[
      ...
      <div id="instructor-shield"
        ...
        <div v-else class="space-y-4">
          ...
          <div class="flex justify-between items-center border-b border-gray-150 dark:border-slate-800 pb-2">
            <div
              class="flex bg-slate-100 dark:bg-slate-950 p-0.5 rounded-lg select-none border border-transparent dark:border-slate-800">
          ...
          <div v-if="activeLessonTab === 'edit'" class="space-y-4">
              ...
              <div class="animate-fadeIn">
                <label
                  ...
                  <span class="flex items-center gap-1.5">
                    ...
                    <span
                      class="text-[9px] font-bold text-slate-400 dark:text-slate-500 bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 px-1.5 py-0.25 rounded uppercase tracking-wider">Opcional</span>
                  </span>
                  ...
                  <span v-else
                    class="text-[9px] font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 border border-slate-150 dark:border-slate-705 px-1.5 py-0.25 rounded-md">
            ...
            <div
              class="flex flex-wrap items-center gap-1.5 bg-slate-50 dark:bg-slate-955 p-2 rounded-xl border border-slate-150 dark:border-slate-800">
              <span
                class="text-[10px] text-slate-400 dark:text-slate-500 font-black uppercase tracking-wider mr-1">Markup:</span>
            ...
            <div>
              <label class="block text-xs font-semibold text-gray-700 dark:text-slate-300 mb-1">Conteúdo da Lição
                (Suporta Tabelas, Gráficos e Box) *</label>
              <textarea :id="`textarea-markdown-editor-${activeLessonObject.tempId}`" rows="14" required
          ...
          <div v-if="activeLessonTab === 'preview'" class="space-y-4">
            <div
              class="p-3 bg-slate-50 dark:bg-slate-900/60 rounded-xl border border-indigo-100/40 dark:border-indigo-950/80 text-[11px] text-slate-700 dark:text-slate-300 leading-relaxed">
          ...
          <div v-if="activeLessonTab === 'quiz'" class="space-y-6">
            <div
              class="bg-slate-50 dark:bg-slate-950 p-4 sm:p-5 rounded-xl border border-slate-200 dark:border-slate-850 space-y-4">
              <p class="text-xs font-extrabold text-slate-700 dark:text-slate-300 uppercase tracking-wider text-left">
                Adicionar Questão de Múltipla Escolha</p>

              <div class="space-y-3 text-left">
                <div>
                  <label class="block text-xs font-bold text-slate-650 dark:text-slate-350 mb-1">Enunciado da Pergunta
                    *</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                  <div class="sm:col-span-1">
                    <label class="block text-xs font-semibold text-slate-700 dark:text-slate-350 mb-1">Qual a opção
                      correta? *</label>
