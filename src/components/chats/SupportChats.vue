...
<template>
  <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch h-[calc(100vh-220px)] min-h-[550px] relative">
    ...
    <div class="md:col-span-5 bg-white dark:bg-slate-900 p-5 rounded-2xl border border-gray-100 dark:border-slate-800 flex flex-col justify-between text-left h-full">
    ...
    <div class="md:col-span-7 bg-white dark:bg-slate-900 p-5 rounded-2xl border border-gray-100 dark:border-slate-800 flex flex-col justify-between text-left h-full overflow-hidden">
      <template v-if="selectedRoomId && activeRoom">
        ...
        <div class="border-b border-slate-100 dark:border-slate-800 pb-3 flex items-center justify-between shrink-0">
          <div>
            <span class="text-[9px] text-blue-600 dark:text-blue-300 font-extrabold uppercase tracking-widest bg-blue-50 dark:bg-blue-950/40 px-2 py-0.5 rounded">{{ activeRoom.courseTitle }}</span>
          ...
          >
            <div :class="[
              ...
              <span 
                ...
                class="text-[10px] font-black tracking-tight block mb-1"
            ...
            <span class="text-[8px] text-slate-400 dark:text-slate-500 mt-1 mx-1.5 font-mono font-bold">{{ formatMessageTime(msg.createdAt) }}</span>
          </div>
        </div>
        ...
        <div class="relative shrink-0">
          ...
          <div v-if="showEmojiPicker" class="absolute bottom-14 right-0 left-0 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-2xl rounded-2xl p-4 z-50 animate-fadeIn flex flex-col">
